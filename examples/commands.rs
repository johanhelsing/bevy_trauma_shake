//! This example shows how to use the commands-based trauma API
//!
//! The commands API is an alternative to the events-based API that can be used
//! in rollback contexts.
